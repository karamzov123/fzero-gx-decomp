...
extern unsigned char lbl_801A7204[4];
extern unsigned char lbl_801A7200[4];
extern unsigned char lbl_801A71F0[4];
extern unsigned char lbl_801A6C70[4];
extern unsigned char lbl_801A720C[4];
extern unsigned char lbl_801A71F4[4];
extern unsigned char lbl_801A71FC[4];
extern unsigned char lbl_801A7208[4];
...
asm void fn_8003EC44(register void* a)
{
    ...
    lfd f7, 0x98(r1)
    stfs f1, 0x1c(r1)
    lfs f6, lbl_801A71F0(r2)
    lwz r0, 0x1c(r1)
    fsubs f8, f8, f9
    fsubs f7, f7, f9
    lfs f4, lbl_801A6C64(r13)
    clrlwi r0, r0, 1
    stw r0, 0x1c(r1)
    fdivs f30, f8, f7
    lfs f1, 0x1c(r1)
...
_8003ed58:
    ...
    stw r3, 0x80(r1)
    subf r0, r4, r0
    lfd f3, lbl_801A71D0(r2)
    stw r0, 0x7c(r1)
    lfd f0, 0x80(r1)
    stw r3, 0x78(r1)
    fsubs f1, f0, f3
    lfs f4, lbl_801A71F4(r2)
    lfd f2, 0x78(r1)
    lfs f0, lbl_801A71E4(r2)
    fsubs f2, f2, f3
    fmuls f1, f1, f30
...
_8003f4ac:
    ...
    lfs f4, lbl_801A6C64(r13)
    fsubs f0, f0, f3
    lfs f3, lbl_801A71FC(r2)
    fadds f4, f6, f4
    fdivs f2, f2, f0
    lfs f5, lbl_801A71F4(r2)
    lfs f0, lbl_801A71E4(r2)
    lwz r3, 0x20(r30)
    lwz r0, 0x24(r30)
    fmuls f1, f2, f1
...
_8003f628:
    ...
    subf r31, r4, r3
    beq _8003f728
    lfs f1, lbl_801A71F0(r2)
    lfs f0, lbl_801A6C64(r13)
    lfs f2, lbl_801A71F4(r2)
    fadds f0, f1, f0
    lfs f4, lbl_801A71FC(r2)
    lwz r4, 0x90(r30)
    lwz r0, 0x94(r30)
...
_8003f728:
    ...
    lfd f3, lbl_801A71D0(r2)
    stw r3, 0x7c(r1)
    lfs f7, lbl_801A71FC(r2)
    stw r0, 0x78(r1)
    lfs f4, lbl_801A71F0(r2)
    lfd f0, 0x78(r1)
    stw r0, 0x80(r1)
    fsubs f1, f0, f3
    lfs f2, lbl_801A6C64(r13)
    lfd f0, 0x80(r1)
    fadds f4, f4, f2
    lfs f5, lbl_801A71F4(r2)
    fmuls f2, f7, f1
    lfs f6, lbl_801A7208(r2)
    fsubs f1, f0, f3
    fadds f3, f5, f4
    lfs f0, lbl_801A71E4(r2)
    fdivs f29, f2, f1
...
asm void fn_8003F834(register void* a)
{
    ...
    li r5, 4
    bl GXBegin
    lfs f2, lbl_801A720C(r2)
    lis r3, -0x33ff
    lfs f1, lbl_801A71F8(r2)
    fadds f3, f31, f30
    stfs f2, -0x8000(r3)
    lfs f0, lbl_801A71C8(r2)
    stfs f31, -0x8000(r3)
    stfs f1, -0x8000(r3)
    stfs f2, -0x8000(r3)
    stfs f3, -0x8000(r3)
