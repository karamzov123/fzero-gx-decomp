...
extern unsigned char _Internal_Error_adxm_goto_mwidle_border_str[];
extern unsigned char lbl_8012B918[];
extern unsigned char lbl_8017E5BC[];
extern unsigned char lbl_8017E984[];
extern unsigned char lbl_8009115C[];
extern unsigned char lbl_80091198[];
extern unsigned char lbl_8012B930[];
...
asm void fn_8004E59C(void)
{
    ...
    stw	r0, 0x14(r1)
    stw	r31, 0xc(r1)
    addi    r5, r5, lbl_8017E980@l
    stw	r30, 8(r1)
    mr	r30, r3
    addi    r4, r4, lbl_8009115C@l
    lwz	r0, 4(r31)
    lwz	r3, 0(r3)
    cmpwi	r0, 0
    bne     _8004e790
