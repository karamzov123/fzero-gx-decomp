...
void axmix_ctrl_init_type2(void *arg0)
{
    // provenance: original retail disassembly 0x800284CC axmix_ctrl_init_type2
    // variant 1
    *(int *)((char *)arg0 + 4) = 2;
    *(char *)((char *)arg0 + 8) = 0x40;
    *(char *)((char *)arg0 + 9) = 0x7f;
}


void axmix_ctrl_init_type5(void *arg0)
{
    // provenance: original retail disassembly 0x800284E8 axmix_ctrl_init_type5
    // variant 1
    *(int *)((char *)arg0 + 4) = 5;
    *(int *)((char *)arg0 + 8) = 0;
}
