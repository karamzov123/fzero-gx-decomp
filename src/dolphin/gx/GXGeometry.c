...
extern unsigned char jumptable_8012B120[];
extern unsigned char jumptable_8012B140[];
extern unsigned char jumptable_8012B234[];
extern unsigned char jumptable_8012B328[];
...
_8003545c:
    ...
    cmplwi	r31, 6
    bgt     _80035580
    lis     r3, jumptable_8012B120@ha
    addi    r3, r3, jumptable_8012B120@l
    slwi	r0, r31, 2
    lwzx	r0, r3, r0
    mtctr	r0
    bctr	
...
asm void fn_80035A2C(register void* p1, register void* p2, register int id, register void* p4)
{
    ...
    stw	r31, 0x24(r1)
    bgt     _80035a78
    lis     r8, jumptable_8012B140@ha
    addi    r8, r8, jumptable_8012B140@l
    slwi	r0, r5, 2
    lwzx	r0, r8, r0
    mtctr	r0
    bctr	
...
asm void fn_80035B88(register void* p1, register void* p2, register int id, register void* p4)
{
    ...
    cmplwi	r3, 0x3c
    bgt     _80035bcc
    lis     r9, jumptable_8012B234@ha
    addi    r9, r9, jumptable_8012B234@l
    slwi	r0, r3, 2
    lwzx	r0, r9, r0
    mtctr	r0
    bctr	
...
_80035d78:
    ...
    stw	r0, 0xc(r31)
    bgt     _80035e5c
    lis     r5, jumptable_8012B328@ha
    addi    r5, r5, jumptable_8012B328@l
    slwi	r0, r7, 2
    lwzx	r0, r5, r0
    mtctr	r0
    bctr	
