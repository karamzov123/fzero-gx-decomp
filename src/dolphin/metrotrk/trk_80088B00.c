...
extern s32 TRKAcquireMutex_stub(void);
...
extern s32 TRKDoUnsupported_Override(void);
extern s32 TRKDoUnsupported_SupportMask(void);
...
extern s32 TRKReleaseMutex_stub(void);
extern s32 fn_8008AF50(void);
