...
# retail layout, that is called out in a comment rather than silently
# reordered away — read the comment before "fixing" an ordering that looks
# odd here.
config.libs = [
    GameLib("game", [
        ...
        Object(Matching, "game/criadx_800443AC.c", mw_version="GC/1.3"),
        ...
        Object(Matching, "game/adxt_80053A30.c",
               mw_version="GC/1.3",
               extra_cflags=["-use_lmw_stmw on"]),
        Object(Matching, "game/adxt_80053EA0.c", mw_version="GC/1.3", extra_cflags=["-use_lmw_stmw on"]),
        ...
        # GC/1.3 pinned by discriminator evidence
    ...
    # Temporary generator validation: option aggregate text unit.
    Rel("option", [
        Object(Matching, "option/auto_00_00000000_text", source="option/auto_00_00000000_text.c"),
    ]),
    # Module-scoped source for the sample REL's autogenerated text unit.
    # The other functions in this unit remain literal asm until independently
    # supported; only fn_18_3FC has a natural-C body.
    Rel("sample", [
        Object(
            Matching,
            "sample/auto_00_00000000_text",
            source="sample/auto_00_00000000_text.c",
        ),
    ]),
    # Module-scoped replay REL source: only fn_13_A40 is natural C; all other
    # functions in the autogenerated unit remain literal asm.
    Rel("replay", [
        Object(
            Matching,
            "replay/auto_00_00000000_text",
            source="replay/auto_00_00000000_text.c",
        ),
    ]),
]
